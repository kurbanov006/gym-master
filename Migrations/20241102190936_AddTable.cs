        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CareerStart = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_BaseUser_Email", x => x.Email);
                    table.ForeignKey(
                        name: "FK_BaseUser_Gyms_GymId",
                        column: x => x.GymId,
                        principalTable: "Gyms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserServiceId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserClientId = table.Column<int>(type: "integer", nullable: false),
                    UserTrainerId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserServices_BaseUser_UserClientId",
                        column: x => x.UserClientId,
                        principalTable: "BaseUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserServices_BaseUser_UserTrainerId",
                        column: x => x.UserTrainerId,
                        principalTable: "BaseUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserServices_UserClientId",
                table: "UserServices",
                column: "UserClientId");

            migrationBuilder.CreateIndex(
                name: "IX_UserServices_UserTrainerId",
                table: "UserServices",
                column: "UserTrainerId");
        }
